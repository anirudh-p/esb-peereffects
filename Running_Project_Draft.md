...
Re-estimating our 2SLS model on `Peer Operating` yields a point estimate of `0.0194 (SE: 0.0082, p=0.0176)`. The effect size is nearly triple the baseline vendor-admin effect (0.0063) once isolated strictly to the physical delivery constraint. This provides extraordinarily robust evidence that physical visibility drives massive peer demand.
