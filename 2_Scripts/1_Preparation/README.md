...
- `03_build_spatial_design_exposure.py`: builds geometry coverage diagnostics, focal-unit/sample flags, hybrid and EDGE-only KNN graphs, spatial exposure variables, the simple priority-cell BH R1 design layer, the simulated R1 selection-rule recentered design layer used in Spec C, and the all-districts-applied recentering layer used in Spec D.
