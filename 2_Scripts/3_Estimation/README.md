...
- `00_run_all.do`: runs the currently implemented table sequence: sample selection, Spec A, Spec B, Spec C, Spec D, the Spec C non-applicant restriction, and the Spec C radius robustness table. Timing and mechanism scripts are intentionally left out until implemented.
