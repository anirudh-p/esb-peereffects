...
- `00_run_all.do`: runs the currently implemented table sequence: sample selection, Spec A, Spec B, Spec C, and Spec D. Timing and mechanism scripts are intentionally left out until implemented.
