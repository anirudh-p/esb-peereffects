...
- `03_specC_hazard_panel_design_bh_iv.do`: main design-based Borusyak-Hull-style IV specification using recentered neighbor R1 exposure and expected-exposure controls.
